...
struct StrictProtocolJSONAuditor {
    private static let maximumDepth = 64
    private static let maximumScalarBytes = 64 * 1_024
    ...
    private mutating func parseString() throws -> String {
        ...
        while index < bytes.count {
            ...
            if byte == 0x22 {
                guard
                    output.count <= Self.maximumScalarBytes,
            ...
            guard output.count <= Self.maximumScalarBytes else {
                throw InvestigationEnvelopeV2Error.invalidJSON
            }
        }
        throw InvestigationEnvelopeV2Error.invalidJSON
    ...
    private mutating func consumeLiteral(_ literal: String) throws {
        ...
        guard
            index + literalBytes.count <= bytes.count,
