...
root-cause 修复已通过非提权 focused/structural/binary gates，但新 campaign 尚未
授权。后续 serial validation 暴露历史 physical fixture 会触发 production
stale-recovery 并移除 v9 Gate capsule；精确副本不可恢复，原 v2 receipt 与当前
v3 post-mutation receipt 已分别保留，fixture 已改为显式 opt-in + 双重拒绝历史
attempt。L3c3d/L3c4
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 active after consumed v8/v9 no-go；v10 authorized/unconsumed and in preflight；Task 40 remains blocked；machine admission unavailable |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8/v9 consumed/no-go；root-cause repair green；v10 authorized/unconsumed |
...
| [docs/reports/phase-d-task-39b2c-iic-v9-failure-disposition.md](docs/reports/phase-d-task-39b2c-iic-v9-failure-disposition.md) | v9 consumed failure、AMFI `-423` root cause、原 Gate residue v2 receipt 与后续 test-mutation v3 disposition |
| [docs/reports/phase-d-task-39b2c-iic-v10-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v10-replacement-campaign-authorization.md) | 用户批准的一次 fresh v10 campaign；绑定 `05fd0cd`、operator-only credential、one-shot/failure-stop 与 fresh evidence 边界 |
