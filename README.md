...
完成/non-admitting，final verifier review none；当前 frontier 为
ii-c-c unique real machine campaign → L3c3d → L3c4；这些 repairs 是
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete，Task 39B2c in progress；resolved-lineage L1/L2 complete/non-admitting，final verifier review none；current frontier ii-c-c unique real machine campaign → L3c3d → L3c4；machine admission pending |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b and resolved-lineage L1/L2 implementation complete/non-admitting；ii-c-c unique real machine campaign current；unique privileged attempt unconsumed |
