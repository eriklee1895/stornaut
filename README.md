...
launch/root action，v15 superseded/unconsumed。修复已实现/non-admitting，
等待基于新 pushed commit 的授权。
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 active after consumed v8–v13 no-go；v14/v15 superseded/unconsumed；evidence closure implemented/non-admitting；Task 40 remains blocked |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8–v13 consumed/no-go；v14/v15 superseded/unconsumed；fresh authorization required after evidence closure |
