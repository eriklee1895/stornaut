...
ii-c-b1 已以 implementation `77cde61` / tree `9c59f241`、7 paths / 1,900
lines、860/860 serial 与无 unresolved P0–P2 review 完成并保持 non-admitting；
ii-c-b2a1 又以 implementation `e3555ec` / tree `f38783f`、4 paths / 3,749
...
与无 unresolved P0–P2 review 完成；resolved-lineage L1 已完成，L2
implementation、cross-UID/PID-reuse corrections 与 mutation-oracle fix 也已
...
campaign v9；首次 launcher 启动在未认证 install 提示处取消且未消费，修复后
invocation 已到达 `armedConsumed`，随后因 AMFI `-423` 拒绝携带受限 entitlement
的 ad-hoc MachineDriver 而 `spawnUncertain → terminal`。v9 已消费且不可重试；
root-cause 修复已通过非提权 focused/structural/binary gates。后续 serial validation 暴露历史 physical fixture 会触发 production
stale-recovery 并移除 v9 Gate capsule；精确副本不可恢复，原 v2 receipt、v3
predecessor 与当前 v5 receipt 已分别保留，fixture 已改为显式 opt-in + 双重拒绝历史
attempt。v10 随后从 `b9ade5e` 执行并越过 AMFI 边界，但在 durable arm 后
...
failure projection；retained v11 Gate capsule preservation prerequisite 已完成。
v12 已从 `212320f` 唯一执行并在 durable arm 后因无界 post-arm
authorization path 超过 1,400 秒 campaign horizon 而消费失败；checked
disposition 为 `consumedPostArmAuthorizationDeadlineExhaustion`，不可重试。
bounded credential repair 与 persistent Gate P1/P2 已完成。v13 随后从
`8885161` 唯一执行，以 closed `receiptInvalid/exited-82` 在 shared deadline
...
前的 fresh v14 曾基于 `d5a7df3` 获批，但在任何 launch/root action 前因
exact v13 preservation P0 而 superseded/unconsumed；prerequisite 已实现/
non-admitting。fresh v15 曾基于 `facf3ea` 获批，但 pre-arm review 发现
aggregate scope enforcement 与 xattr no-mutation evidence gaps；未发生
launch/root action，v15 superseded/unconsumed。修复已由 `103a4836` 推送并
...
attribution repairs 已完成/non-admitting；fresh v17 曾基于 `a69bd33` 获批，
但在 launch 前发现 TMPDIR 中的 v13 raw evidence 丢失，且与 macOS low-disk
purge 强时间相关（精确删除 actor 未独立绑定），因而
superseded/unconsumed；当前先关闭 v13 purge disposition 与 future evidence
persistent-path repair；L3c3d/L3c4
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 active after consumed v8–v13/v16 no-go；v14/v15/v17 superseded/unconsumed；persistent evidence repair pending；Task 40 remains blocked |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8–v13/v16 consumed/no-go；v14/v15/v17 superseded/unconsumed；persistent evidence repair pending |
...
| [docs/reports/phase-d-task-39b2c-iic-v9-failure-disposition.md](docs/reports/phase-d-task-39b2c-iic-v9-failure-disposition.md) | v9 consumed failure、AMFI `-423` root cause、v2/v3 前序与当前 v5 subsequent-campaign binding |
| [docs/reports/phase-d-task-39b2c-iic-v10-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v10-replacement-campaign-authorization.md) | 用户批准的一次 fresh v10 campaign；已消费并按 failure-stop 禁止重试 |
| [docs/reports/phase-d-task-39b2c-iic-v10-failure-disposition.md](docs/reports/phase-d-task-39b2c-iic-v10-failure-disposition.md) | v10 consumed deadline exhaustion；1,195.056190 秒 durable timeline；non-admitting/non-retryable |
| [docs/reports/phase-d-task-39b2c-iic-v11-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v11-replacement-campaign-authorization.md) | 用户批准并已消费的一次 fresh v11 campaign；绑定 `8a286ea`；禁止重试 |
| [docs/reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md) | 用户重新绑定至 `0a17726` 的一次 fresh v12 campaign；consumed/non-admitting/non-retryable |
| [docs/reports/phase-d-task-39b2c-iic-v12-failure-disposition.md](docs/reports/phase-d-task-39b2c-iic-v12-failure-disposition.md) | v12 post-arm authorization-path deadline exhaustion 与后续 Gate cache residue loss；consumed/non-admitting/non-retryable |
| [docs/reports/phase-d-task-39b2c-iic-v12-credential-deadline-repair-review.md](docs/reports/phase-d-task-39b2c-iic-v12-credential-deadline-repair-review.md) | bounded no-signal credential reader；complete/non-admitting |
| [docs/reports/phase-d-task-39b2c-iic-persistent-gate-p2-review.md](docs/reports/phase-d-task-39b2c-iic-persistent-gate-p2-review.md) | schema-v3 lock-only evidence、atomic first-create、1,964-test serial、双 review clean；complete/non-admitting |
...
| [docs/reports/phase-d-task-39b2c-iic-v14-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v14-replacement-campaign-authorization.md) | 基于 `d5a7df3` 的 v14 授权在 launch 前被 preservation P0 supersede；unconsumed，必须重绑 |
| [docs/reports/phase-d-task-39b2c-iic-v15-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v15-replacement-campaign-authorization.md) | 基于 `facf3ea` 的 v15 授权在 pre-arm review 后 superseded/unconsumed；未启动，必须重绑 |
| [docs/reports/phase-d-task-39b2c-iic-v16-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v16-replacement-campaign-authorization.md) | 基于 `103a4836` 的 v16 one-shot 授权已消费；non-admitting/non-retryable |
| [docs/reports/phase-d-task-39b2c-iic-v17-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v17-replacement-campaign-authorization.md) | 基于 `a69bd33` 的 v17 one-shot 授权；launch 前发现 v13 TMPDIR evidence 丢失且与系统 low-disk purge 强时间相关（精确删除 actor 未独立绑定）；superseded/unconsumed |
| [docs/reports/phase-d-task-39b2c-iic-v13-raw-evidence-loss-review.md](docs/reports/phase-d-task-39b2c-iic-v13-raw-evidence-loss-review.md) | v13 raw evidence 外部丢失的只读 disposition；不重建原字节，保留 v13/v16 Gate lineage；complete/non-admitting |
| [docs/reports/phase-d-task-39b2c-iic-v16-failure-disposition.md](docs/reports/phase-d-task-39b2c-iic-v16-failure-disposition.md) | v16 schema-v9 checked failure；九个 artifacts、双 persistent Gate、AMFI supplemental observation；successor repair complete |
...
| [docs/reports/phase-d-task-39b2c-iic-b2b-transport-preflight.md](docs/reports/phase-d-task-39b2c-iic-b2b-transport-preflight.md) | ii-c-b2b exact 11-path / 3,600-line PTY/FD3 transport scope；historically superseded by resolved-lineage L2 |
| [docs/reports/phase-d-task-39b2c-iic-resolved-root-driver-lineage-l1-review.md](docs/reports/phase-d-task-39b2c-iic-resolved-root-driver-lineage-l1-review.md) | resolved-lineage L1 implementation `83f6271` / tree `98289e2`；complete/non-admitting |
| [docs/reports/phase-d-task-39b2c-iic-resolved-root-driver-lineage-l2-review.md](docs/reports/phase-d-task-39b2c-iic-resolved-root-driver-lineage-l2-review.md) | resolved-lineage L2 implementation `474f634`、cross-UID/PID-reuse fixes 与 verifier closure `849e454`；single staged-only serial failed with 27 issues at 1,878/99，exact low-load reruns 109/109；final review none；后续 ii-c-c v8 已消费失败且不可重试 |
