...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 blocked after consumed v8/v9 no-go；v9 post-mutation audit and AMFI repair green；new campaign not authorized；Task 40 remains blocked；machine admission unavailable |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8/v9 consumed/no-go；root-cause repair green；new campaign not authorized |
