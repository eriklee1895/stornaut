...
failure projection；基于 `4fd9c53` 的 fresh v12 privileged campaign 已获批准，
但因 retained v11 Gate capsule preservation prerequisite 而 suspended/unconsumed；
修复后必须重新绑定授权。L3c3d/L3c4
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 active after consumed v8/v9/v10/v11 no-go；v12 approved but suspended/unconsumed/rebind required；Task 40 remains blocked |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8/v9/v10/v11 consumed/no-go；v12 approved but suspended/unconsumed/rebind required |
...
| [docs/reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md) | 用户批准的一次 fresh v12 campaign；preflight suspended/unconsumed；repair 后需重新绑定 |
