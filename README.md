...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c split：ii-c-a/ii-c-b1/b2a1/b2a2 complete/non-admitting；b2b PTY/FD3 transport current；ii-c-c owns the unique privileged campaign |
