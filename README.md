...
authorization path 超过
1,400 秒 campaign horizon 而消费失败；checked disposition 为
`consumedPostArmAuthorizationDeadlineExhaustion`，不可重试。bounded credential repair
已实现并保持 non-admitting；v11/v12 Gate cache residue 随后外部丢失，删除者
未知，持久路径迁移仍为新的 machine prerequisite。L3c3d/L3c4
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 active after consumed v8–v12 no-go；persistent Gate P2 complete/non-admitting；v13 authorized/pending/unconsumed at `c7c94eb`；Task 40 remains blocked |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8–v12 consumed/no-go；persistent Gate P2 complete；v13 authorized/pending/unconsumed |
...
| [docs/reports/phase-d-task-39b2c-iic-v13-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v13-replacement-campaign-authorization.md) | 用户批准基于 `46e1f94` 的一次 fresh v13；authorized/pending/unconsumed，operator-only credential |
