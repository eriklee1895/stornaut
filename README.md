...
fresh v12 privileged campaign 已重新绑定至 `0a17726`，当前 authorized /
pending / unconsumed。L3c3d/L3c4
...
| [docs/plans/active/README.md](docs/plans/active/README.md) | Phase D approved；Tasks 36–38 complete；Task 39 active after consumed v8/v9/v10/v11 no-go；v12 authorized/pending/unconsumed at `0a17726`；Task 40 remains blocked |
...
| [docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md](docs/reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) | ii-c-b complete/non-admitting；v8/v9/v10/v11 consumed/no-go；v12 authorized/pending/unconsumed at `0a17726` |
...
| [docs/reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md](docs/reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md) | 用户重新绑定至 `0a17726` 的一次 fresh v12 campaign；authorized/pending/unconsumed |
