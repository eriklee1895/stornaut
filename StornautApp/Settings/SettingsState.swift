...
enum SettingsCodexAuthenticationStatus:
    String,
    CaseIterable,
    Sendable,
    Equatable
...
struct SettingsCodexStatus: Sendable, Equatable {
    ...
    let authenticationStatus: SettingsCodexAuthenticationStatus

    init(
        availability: SettingsCodexAvailability,
        executablePath: PersistedPath?,
        version: String?,
        syntaxStatus: SettingsCodexSyntaxStatus,
        authenticationStatus: SettingsCodexAuthenticationStatus = .unverified
    ) {
        self.availability = availability
        self.executablePath = executablePath
        self.version = version
        self.syntaxStatus = syntaxStatus
    ...
    static let installedSupportedAuthenticated = SettingsCodexStatus(
        availability: .installed,
        executablePath: nil,
        version: nil,
        syntaxStatus: .supported,
...
struct SettingsRuntimeEvidenceReceipt: Sendable, Equatable {
    ...
    let verifiedAt: Date
    let expiresAt: Date
    let appIdentity: DomainToken
    let helperIdentity: DomainToken
    let serviceIdentity: DomainToken
    let promptRevision: DomainToken
    let schemaRevision: DomainToken
...
struct SettingsRuntimeEvidence: Sendable, Equatable {
    ...
    static func admitted(
        _ receipt: SettingsRuntimeEvidenceReceipt
...
struct SettingsSnapshot: Sendable, Equatable {
    ...
    let disclosureReadiness: DeepDiveDisclosureReadiness
    let dependencyReadiness: DeepDiveDependencyReadiness
    ...
    init(
        ...
        self.disclosureReadiness = disclosureReadiness
    ...
    func replacing(
        ...
        disclosureReadiness: DeepDiveDisclosureReadiness? = nil,
        dependencyReadiness: DeepDiveDependencyReadiness? = nil,
        ...
        SettingsSnapshot(
            ...
            disclosureReadiness:
                disclosureReadiness ?? self.disclosureReadiness,
            dependencyReadiness:
                dependencyReadiness ?? self.dependencyReadiness,
