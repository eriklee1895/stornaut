...
struct AppDependencies: Sendable {
    ...
    let evaluateDeepDiveFirstUse: @Sendable (
        DeepDiveFirstUseRequest,
        DeepDiveAdmissionDimensions
    ) async -> DeepDiveFirstUseEvaluation
    let submitDeepDiveDisclosure: @Sendable (
        DeepDiveFirstUseDecision,
        Date
    ) async -> DeepDiveFirstUseDecisionResult
    let forgetDeepDiveDisclosureAcceptance: @Sendable () async
    ...
    init(
        ...
        evaluateDeepDiveFirstUse: @escaping @Sendable (
            DeepDiveFirstUseRequest,
            DeepDiveAdmissionDimensions
        ) async -> DeepDiveFirstUseEvaluation = { _, _ in
            .notApplicable
        },
        submitDeepDiveDisclosure: @escaping @Sendable (
            DeepDiveFirstUseDecision,
            Date
        ) async -> DeepDiveFirstUseDecisionResult = { _, _ in
            .persistenceFailed
        },
        ...
        self.evaluateDeepDiveFirstUse = evaluateDeepDiveFirstUse
        self.submitDeepDiveDisclosure = submitDeepDiveDisclosure
        self.forgetDeepDiveDisclosureAcceptance =
            forgetDeepDiveDisclosureAcceptance
    ...
    static func live(
        ...
        } makeDeepDiveFirstUseOwner: {
            try DeepDiveFirstUseDecisionOwner(
    ...
    private static func liveDependencies(
        ...
        return AppDependencies(
            ...
            evaluateDeepDiveFirstUse: {
                await runtime.evaluateDeepDiveFirstUse(
                    $0,
                    dimensions: $1
                )
            },
            submitDeepDiveDisclosure: {
                await runtime.submitDeepDiveDisclosure(
                    $0,
                    decidedAt: $1
                )
            },
            forgetDeepDiveDisclosureAcceptance: {
                await runtime.forgetDeepDiveDisclosureAcceptance()
            },
...
private actor AppQuickScanRuntime {
    ...
    private let makeKnowledgeStore: @Sendable () async throws
        -> LocalKnowledgeStore
    private let makeDeepDiveFirstUseOwner: @Sendable () throws
    ...
    private var deepDiveFirstUseOwner: DeepDiveFirstUseDecisionOwner?
    ...
    init(
        ...
        makeKnowledgeStore: @escaping @Sendable () async throws
            -> LocalKnowledgeStore,
        makeDeepDiveFirstUseOwner: @escaping @Sendable () throws
            -> DeepDiveFirstUseDecisionOwner = {
                try DeepDiveFirstUseDecisionOwner(
                    configuration: LocalStoreConfiguration.production()
                )
        ...
        self.makeDeepDiveFirstUseOwner = makeDeepDiveFirstUseOwner
    ...
    func loadSettings() async throws -> SettingsSnapshot {
        ...
        let disclosureReadiness = try await resolvedDeepDiveFirstUseOwner()
            .disclosureReadiness()
        ...
        return SettingsSnapshot(
            ...
            dependencyReadiness: .task38FacadeUnavailable,
    ...
    func evaluateDeepDiveFirstUse(
        _ request: DeepDiveFirstUseRequest,
        dimensions: DeepDiveAdmissionDimensions
    ) async -> DeepDiveFirstUseEvaluation {
        do {
            return try await resolvedDeepDiveFirstUseOwner().evaluate(
                request: request,
    ...
    func submitDeepDiveDisclosure(
        ...
        do {
            return try await withWorkflowLease(.settingsMutation) {
                try await resolvedDeepDiveFirstUseOwner().submit(
                    decision,
                    decidedAt: decidedAt
                )
            }
        } catch CleanupWorkflowCoordinatorError.conflict {
        ...
        -> DeepDiveForgetAcceptanceResult
    {
        do {
            return try await withWorkflowLease(.settingsMutation) {
                try await resolvedDeepDiveFirstUseOwner()
                    .forgetAcceptance()
            }
        } catch CleanupWorkflowCoordinatorError.conflict {
            return .operationInProgress
    ...
    private func resolvedDeepDiveFirstUseOwner() async throws
        -> DeepDiveFirstUseDecisionOwner
    {
        if let deepDiveFirstUseOwner {
            return deepDiveFirstUseOwner
        }
        let created = try makeDeepDiveFirstUseOwner()
        deepDiveFirstUseOwner = created
        return created
    }
