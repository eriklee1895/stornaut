...
the consumed/non-admitting replacement v9 also does not satisfy it. The
authorized but still unconsumed v10 campaign must first let Task 39 produce and push a Ready
baseline.
Inputs are:
