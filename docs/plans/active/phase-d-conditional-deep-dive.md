...
> **Current scheduling amendment (2026-09-18):** Follow the
> [three-day closeout sprint](README.md#三天完整收尾冲刺2026-09-18-至-2026-09-20).
> Tasks 40–43 may develop against closed contracts and fixtures before Task 39
> readiness; normal production admission remains exclusive to Task 44. Phase E/F
> local development may overlap. This changes implementation order and repeated
> validation, not product scope, runtime proof or operation authorization.
>
> **Historical checkpoint record:** Originally approved for sequential Tasks
> 36–44; Tasks 36–38 are complete.
...
> and b2b entry/artifact. b0 is frozen/non-admitting; iii-a, iii-b1, iii-b2a0
> and iii-b2a-i are complete/non-admitting. iii-b2a-ii-a1 fixed transport and
> inner-role closure, a2-0 untrusted decode, a2-i inherited-PGID App session
> and a2-ii terminal/admission join, iii-b2b-0 Release graph closure and
> iii-b2b-1a-0 canonical helper-provenance carriage and iii-b2b-1a-1 concrete
> outer ownership/terminal observers are complete/non-admitting. iii-b2b-1b
> split into 1b-i and 1b-ii; both are complete/non-admitting. 1b-i closed at
> commit `6b26082` / tree `462d40b`, exact 5 paths / 2,434 changed lines and a
> 1,550-test / 81-suite serial, with no unresolved P0-P2. 1b-ii closed at
> implementation `1c8ab1d` / tree `d7b6c05`, exact 4 paths / 971 changed
> lines, contract/App-Release exit 0 and no unresolved P0-P2, then immutable
> seal `a314b85` / tree `aac9d81`. ii-c0b is frozen into c0b-i/c0b-ii/
> c0b-iii/c0b-iv. c0b-i is complete/non-admitting at implementation
> `2493e0f` / parent `e5ed33e` / tree `8155d64`, exact 7 non-document paths /
...
> 1,981 lines and 132 concrete cases. a2 is complete/non-admitting at
...
> iv-b1a, iv-b1b-i and iv-b1b-ii are also complete/non-admitting. iv-b1b-i closed at
...
> target build and two no-unresolved-P0-P2 final reviews. iv-b1b-ii closed at
> implementation `373431d4` / tree `b08342e5`, exact five paths / 2,193 changed
> lines, seven physical scenarios, 808/808 clean serial, three dedicated gates
> and three no-unresolved-P0-P2 review groups. iv-b2 closed at implementation
...
> was not retried. Its failure disposition is now independently bound by a
> self-sealed read-only verifier as consumed transport loss / non-admitting /
> non-retryable; the original evidence tree remains unchanged. L3c3d and L3c4
> remain blocked on an authorized green machine cohort. These
...
> The former Task 40 sequential development block is superseded by the current
> sprint for closed-fixture/non-production work; Task 44 remains blocked
...
> admission and the remaining authoritative full.
>
...
- 39B2c L3a/L3b are complete. The mandatory L3c scope/trust preflight split
  ...
  ii-b5 is split into b5a0/b5a/b5b-i/b5b-ii/b5b-iii; b5a0/b5a, all b5b-i checkpoints through aggregate i-c2, ii-b5b-ii-a/ii-b/ii-c/ii-d and ii-c0a are complete/non-admitting. A fresh source/topology audit further splits ii-b5b-iii as `iii-b0 -> iii-a -> iii-b1 -> iii-b2a0 -> iii-b2a-i -> iii-b2a-ii-a -> iii-b2b`; b0 is frozen/non-admitting and iii-a/iii-b1/iii-b2a0/iii-b2a-i/iii-b2a-ii-a1 are complete/non-admitting. The a2 scope/trust preflight freezes `a2-0 -> a2-i -> a2-ii`; a2-0/a2-i/a2-ii, iii-b2b-0, iii-b2b-1a-0, iii-b2b-1a-1, iii-b2b-1b and c0b-i are complete/non-admitting; ii-c0b is frozen into `c0b-i -> c0b-ii -> c0b-iii -> c0b-iv`; c0b-ii is further split into `ii-c0b-ii-a -> ii-c0b-ii-b`; the ii-a budget split is frozen as `ii-c0b-ii-a1 -> ii-c0b-ii-a2`, and both children are complete/non-admitting. ii-c0b-ii-a2 closed at implementation `f11eea42ef295f49b20e1c0f3912d4b32448b968` / tree `d0683495ea37d0692677c98f491f3037eaedba4c`, exact 4 paths / 889 lines and aggregate 7 paths / 2,870 lines, with bare contract/component/App-Release exit 0 and two no-unresolved-P0-P2 reviews; it ran no serial/full/root/App/XPC/model/network. The retained-base/publication/settlement sequence, c0b-iii, and c0b-iv through iv-b2 are complete/non-admitting; iv-b2 closed at implementation `4e8d672d35e4416b0114c5c4dbebb1cb6a4d5089` / tree `e02a515283225b0b19443a47fad0b90fe3d0ddfd`. Shared-deadline repair `c144c1e`, fixed-gate deadline cleanup repair `bc42fbc`, interactive-native identity binding repair `531f79f` / consumer seal `26e785a`, fixed-gate historical replay `aa8a7f1`, and ii-c-a `81f185c` / tree `7cf4db75` are complete/non-admitting. The historical pre-v8 order was strictly `ii-c-b -> ii-c-c -> L3c3d -> L3c4`; v8 is now consumed, failed, and non-retryable, so no live machine frontier exists without explicit user approval for a replacement privileged campaign and plan amendment; these repairs are machine-campaign prerequisite checkpoints, not new Tasks. c0b-i closed at implementation `2493e0f` / parent `e5ed33e` / tree `8155d64`, exact 7 non-document paths / 1,900 changed lines, 95 tests / 5 suites, three green gates and no unresolved P0-P2; by design it ran no serial/full/root/sudo, App/helper/driver launch, XPC, model/auth or network. iii-b2b-1b split into 1b-i and 1b-ii: 1b-i closed at commit `6b26082` / tree `462d40b`, exact 5 paths / 2,434 changed lines, a 1,550-test / 81-suite serial and no unresolved P0-P2; 1b-ii closed at implementation `1c8ab1d` / tree `d7b6c05`, exact 4 paths / 971 changed lines, contract/App-Release exit 0 and no unresolved P0-P2, followed by immutable seal `a314b85` / tree `aac9d81`. iii-b2b-0 closed at implementation commit `c8cc514` / tree `d615795`, sealed by `6474016`, with exact 7 non-document paths / 1,096 changed lines, 20 focused, 37 target-boundary and 1,517 serial tests, all contract/App-Release gates and no unresolved P0-P2. iii-b2b-1a-0 closed at implementation commit `53c5594` / tree `f9322fa`, with test-only prerequisite `59d3bb7` and immutable seal `8361168`; its exact 8 non-document paths / 1,336 changed lines, 38 target-boundary tests, 1,525-test / 79-suite staged serial, complete contract/App-Release gates and independent review passed. iii-b2b-1a-1 closed at implementation commit `fe4f6ad` / tree `6bd6d384`, sealed by `2c31a7c`, with exact 8 non-document paths / 2,800 changed lines, a 1,535-test / 80-suite staged serial, complete App/Release and contract gates and no unresolved P0-P2. a2-i closed at commit `158f500` / tree `c7a42ffd` with 10 non-document paths / 1,965 changed lines, 66 focused tests, a clean 1,500-test / 78-suite staged-only serial, exact SwiftPM/Xcode projections, complete contract replay and no unresolved P0-P2. a2-ii closed at implementation commit `8eac2c4f` / tree `9e3bdefd`, sealed by `70603a0`, with exact 12 non-document paths / 3,673 changed lines, 55 focused tests, a clean 1,516-test / 79-suite staged-only serial, global source boundary, complete contract/final-Mach-O gates and no unresolved P0-P2. iii-a closed at tree `2eeb307cfb2cf67a1b169e0a510c92ea2dc9dbb2` with exact 10 paths / 3,147 changed lines, 40 focused tests, 559 affected tests, a clean 1,446-test / 74-suite staged-only serial, all three boundary gates and no unresolved P0-P2. iii-b1 then closed at tree `b46d39bfcb4a24cee80b4be9562e281519450cb8` with exact 7 paths / 2,438 changed lines, 13 focused tests, 573 affected tests, a clean 1,455-test / 75-suite staged-only serial, all three boundary gates, immutable replay seal and no unresolved P0-P2. iii-b2a0 closed at commit `65f85c5adbb01b41b1bf9a5f787951f9feb4660d`, parent `7c114e09c915e2685545872101e7c5854ce2cffd`, tree `7df0d5597f498e3588823885d226bdd02befc058` and immutable seal `3f62678306d982edf986acf8a2ef12c3c4081741`, with exact 8 non-document paths / 2,198 changed lines, 36 combined tests / 3 suites, 580 affected tests / 43 suites, a clean 1,462-test / 76-suite staged-only serial, all three boundary gates, targeted Debug/Release builds and no unresolved P0-P2. Its physical result remains an untrusted DTO that cannot enter the single-epoch result or continuity join. iii-b2a-i then closed the canonical supervisor protocol and sole opaque admission seam at commits `2f3a116be4644829fc513bcc2287c6bd2a1ea0ec` and `6f6579834b3f5a707ab7b35152e5425e4260c6ad`, sealed by `30ee32e02fd1ce5fe45a55f64f083f9294c85695`; 12 focused, 593 affected and 1,475 serial tests, all three boundary gates, Debug/Release builds and independent review passed. It remains non-admitting and performed no Darwin spawn, descriptor I/O, privilege, model or authoritative full. iii-b2a-ii-a1 closed fixed transport/inner-role validation at implementation commit `9556367f4f29fc656d4dd45f90b8a61a2ea35f3c`, tree `a66564f527004ea7065b5f6ffeca05a9c12e5fac` and immutable seal `75afc19b36ce92b2f94de1003244ce8ff071f78a`; 9 focused, 603 affected and 1,485 serial tests, exact Debug/Release gates and independent review passed. It remains non-admitting and performed no App/helper/XPC, privilege, model or authoritative full.
  The preceding long-form checkpoint sentence preserves its historical routing.
  It is superseded by the 2026-09-05 immutable v8 blocked/no-go disposition,
  the later v9 authorization and completed shared-deadline repair
  ...
  the
  [ii-c-b2 split preflight](../../reports/phase-d-task-39b2c-iic-b2-split-preflight.md),
  the
  [ii-c-b2a1 evidence producer review](../../reports/phase-d-task-39b2c-iic-b2a1-evidence-producer-review.md),
  the
  [ii-c-b2a2 independent verifier review](../../reports/phase-d-task-39b2c-iic-b2a2-independent-verifier-review.md),
  the
  [ii-c-b2b transport preflight](../../reports/phase-d-task-39b2c-iic-b2b-transport-preflight.md),
  the
  ...
  the [ii-c0b-i review](../../reports/phase-d-task-39b2c-l3c3c-ii-c0b-i-review.md),
  the [ii-c0b-ii ownership preflight](../../reports/phase-d-task-39b2c-l3c3c-ii-c0b-ii-ownership-preflight.md),
  the [shared-deadline completion audit](../../reports/phase-d-task-39b2c-shared-deadline-repair-review.md),
  the [fixed-gate cleanup completion audit](../../reports/phase-d-task-39b2c-fixed-gate-deadline-cleanup-repair-review.md),
  the [interactive-native completion audit](../../reports/phase-d-task-39b2c-interactive-native-identity-binding-repair-review.md),
  the [fixed-gate historical replay preflight](../../reports/phase-d-task-39b2c-fixed-gate-deadline-cleanup-historical-replay-preflight.md),
  the [fixed-gate historical replay completion audit](../../reports/phase-d-task-39b2c-fixed-gate-deadline-cleanup-historical-replay-review.md),
  ...
  the [ii-b5b-iii-b2a-i review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2a-i-review.md),
  the [ii-b5b-iii-b2a-ii-a1-v review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2a-ii-a1-v-review.md),
  the [ii-b5b-iii-b2a-ii-a2-0 review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2a-ii-a2-0-review.md),
  the [ii-b5b-iii-b2a-ii-a2-i review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2a-ii-a2-i-review.md),
  the [ii-b5b-iii-b2a-ii-a2-ii review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2a-ii-a2-ii-review.md),
  the [ii-b5b-iii-b2b-0 review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2b-0-review.md),
  the [iii-b2b-1a-1 review](../../reports/phase-d-task-39b2c-l3c3c-ii-b5b-iii-b2b-1a1-review.md),
  the
...
Follow the current sprint's validation tiers. Reuse accepted upstream studies
unless introducing a new boundary, tool or dependency. Each bounded slice uses
failing tests/fixtures → implementation → focused/affected checks → independent
review → commit/push with exact source and result references.

Tasks 40–43 use scoped validation and actual App/UI evidence where applicable,
not separate full runs plus duplicate serial suites. One necessary serialized
regression covers a stable integration tree; a same-tree final full may supply
that regression instead. Use `swift test --no-parallel`, not the historical
`--parallel false` syntax.

Task 39 L3c4 retains its final safety checkpoint/full. Task 44 retains a final
current-source product full and may share it with Phase E/F only on the same
integrated tree with all applicable evidence covered. Runtime/privilege tests
remain explicit, bounded and separately authorized, never hidden inside ordinary
source/component checks. Historical raw evidence stays immutable; replay changes
require their own focused positive/negative checks rather than weakening proof.

Heavy runs remain serial. UI validation still requires narrow build/test →
actual .app → Peekaboo screenshot/AX inspection → focused XCUITest; static source
inspection cannot substitute. No Task may enable normal product Deep Dive before
Task 44, and no failed/skipped check is counted as passed.
...
## 12. Outside Phase D (not removed from project closeout)

The sprint schedules Phase E Adapters/Actions and Phase F local product quality
alongside Phase D. They remain outside this Task family's implementation scope,
not outside the complete v1 delivery matrix. Public distribution retains its
separate approved gate; prohibited v1 background/remote features remain excluded.
