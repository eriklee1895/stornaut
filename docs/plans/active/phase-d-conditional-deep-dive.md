...
> The current frontier is strictly ii-c, L3c3d and L3c4. These
...
- 39B2c L3a/L3b are complete. The mandatory L3c scope/trust preflight split
  ...
  replay `aa8a7f1`, all non-admitting. The current frontier is
  `ii-c -> L3c3d -> L3c4`.
  See the
