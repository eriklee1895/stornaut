...
> `e02a515283225b0b19443a47fad0b90fe3d0ddfd` and remains non-admitting. The
> current frontier is shared-deadline repair, followed strictly by
> interactive-native binding repair, ii-c, L3c3d and L3c4. The first two are
> machine-campaign prerequisite checkpoints, not new Tasks. The authoritative
