...
ii-b2b-ii legacy-client quarantine / Machine production block are complete;
ii-b2b-iii live-helper server migration is current. See the
...
block is complete; ii-b2b-iii live-helper server migration is current. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-a/ii-b0a/ii-b0b/ii-b0c/ii-b1, ii-b2 ASID prerequisite, ii-b2a/ii-b2b-i/ii-b2b-ii complete; ii-b2b-iii current; ADR 0018 Proposed |
