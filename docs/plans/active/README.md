...
`7cf4db75`. The current frontier is ii-c-b -> ii-c-c -> L3c3d -> L3c4. These
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; ii-c-a complete/non-admitting; current frontier ii-c-b -> ii-c-c -> L3c3d -> L3c4; L3c4 owns the remaining full; ADR 0018 Proposed |
