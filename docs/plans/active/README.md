...
user approved one fresh v12 privileged campaign bound to `4fd9c53`, but
preflight suspended it before launch because stale recovery would remove the
retained v11 Gate capsule. It is unconsumed and requires rebinding after the
preservation repair. Checkpoints 39A,
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | active: v8/v9/v10/v11 consumed; v12 suspended/unconsumed/rebind required; preservation repair active; L3c3d/L3c4 unproven |
