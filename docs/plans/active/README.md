...
fresh v16 is authorized/pending/unconsumed from that exact commit.
Checkpoints 39A,
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | active: v8–v13 consumed/no-go; v14/v15 superseded/unconsumed; v16 authorized/pending/unconsumed; L3c3d/L3c4 unproven |
