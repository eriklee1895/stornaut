...
non-admitting; ii-b5b-i is current. See the
...
ii-b5a0 and ii-b5a are complete/non-admitting, and ii-b5b-i is current. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-b4/ii-b5a0/ii-b5a complete/non-admitting; ii-b5b-i current; ADR 0018 Proposed |
