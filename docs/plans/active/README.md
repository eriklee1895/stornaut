...
ii-c0 before the privileged gate. ii-b0a frame/capsule implementation is complete
after focused/affected/structural gates, one 1,107-test staged-only serial and
independent review; ii-b0b is the current frontier. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-a/ii-b0a complete; ii-b0b current; ADR 0018 Proposed |
