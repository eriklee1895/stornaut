...
the first-frame epoch-origin contradiction; ii-b0c bootstrap is current and ii-b1
is next. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-a/ii-b0a/ii-b0b complete; ii-b0c current; ii-b1 next; ADR 0018 Proposed |
