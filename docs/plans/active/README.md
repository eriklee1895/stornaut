...
i-b2b-b, with i-b2b-a complete/non-admitting and i-b2b-b current, followed by i-b3.
See the
...
ii-b5b-i-b's remaining order is i-b2b-b/i-b3 and i-b2b-b is current. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; i-b2b-a complete/non-admitting; i-b2b-b current; ADR 0018 Proposed |
