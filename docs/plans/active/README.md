...
i-b1, i-b2a, i-b2b-a, i-b2b-b and i-b3 are complete/non-admitting; i-c is
split into i-c1 join/proof and i-c2 legacy closure; i-c1 is current.
See the
...
ii-b5b-i-b is complete through i-b3; i-c is split into i-c1/i-c2 and i-c1 is
current. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; i-b3 complete/non-admitting; i-c1 current then i-c2; ADR 0018 Proposed |
