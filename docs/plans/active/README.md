...
and iii-b2b is current. a2-i closed at implementation commit `158f500` and tree
...
order is iii-b2b -> ii-c0b -> ii-c -> L3c3d -> L3c4.
See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; iii-b2a-ii-a1/a2-0/a2-i/a2-ii complete/non-admitting; iii-b2b current; ADR 0018 Proposed |
