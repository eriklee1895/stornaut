...
i-b1 and i-b2a are complete and non-admitting; i-b2b-a and i-b2b-b are also
complete/non-admitting, with i-b3 current.
See the
...
ii-b5b-i-b's remaining order starts at i-b3; i-b2b-b is complete and
non-admitting. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; i-b2b-a/i-b2b-b complete/non-admitting; i-b3 current; ADR 0018 Proposed |
