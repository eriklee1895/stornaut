...
protocol, a per-epoch continuity, b1 injected cohort, b2a physical adapter and
b2b entry/artifact. b0 is frozen/non-admitting; iii-a per-epoch continuity is
complete/non-admitting and iii-b1 is current. iii-a closed at implementation
...
frozen/non-admitting; iii-a is complete/non-admitting and the remaining order
is iii-b1 -> iii-b2a -> iii-b2b -> ii-c0b -> ii-c -> L3c3d -> L3c4.
See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; iii-a complete/non-admitting; iii-b1 current; ADR 0018 Proposed |
