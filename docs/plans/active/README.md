...
ii-b5a0 is complete/non-admitting and ii-b5a is current.
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-b4/ii-b5a0 complete/non-admitting; ii-b5 split, b5a current; ADR 0018 Proposed |
