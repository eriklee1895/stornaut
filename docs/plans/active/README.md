...
post-fix review; L3c3c-ii-b is the current frontier. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-a complete; ii-b current; ADR 0018 Proposed |
