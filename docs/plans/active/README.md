...
single staged-only serials and independent reviews; ii-b1 is the current frontier. See the
...
| [39](task-39-implementation-brief.md) | Signed-App production-runtime admission | in progress; external root launch NO-GO; ii-a/ii-b0a/ii-b0b complete; ii-b1 current; ADR 0018 Proposed |
