...
> **Status:** Approved for contract/fixture-based development under the
> [three-day sprint](README.md#三天完整收尾冲刺2026-09-18-至-2026-09-20); not yet implemented.
> Integrate usable Task 40/41 interfaces incrementally; do not wait for their
> entire historical sequence. Normal product composition is implemented here
> behind the closed gate; Task 44 alone validates and enables it. Scoped
> validation replaces this Task's former standalone full requirement.
>
> **Parent plan:**
...
Task 42 can start on the accepted Tasks 36–38 contracts and integrate the
reviewed Task 40/41 interfaces as they become available. It includes the closed
normal-product dependency factory formerly deferred to Task 44; tests use
fixtures, and real runtime use remains blocked until Task 39/44 admission.
It must reuse:
