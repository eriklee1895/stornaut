...
> **Status:** Approved for fixture-based UI slices as Task 42 interfaces become
> available under the [three-day sprint](README.md#三天完整收尾冲刺2026-09-18-至-2026-09-20);
> not yet implemented. Production start remains closed until Task 44.
> Actual-window/UI evidence remains mandatory; scoped validation replaces
> this Task's former standalone full requirement.
>
> **Parent plan:**
...
→ focused XCUITest
→ record slice evidence for the Task 44 integrated full
```
...
Fix all P0–P2 findings and rerun affected actual-App/focused checks before
slice completion. The final integrated full remains at Task 44.
