...
ii-b1–ii-b5 并插入 ii-c0；ii-b0a frame/capsule 与 ii-b0b claim/release wire、
各自 staged-only serial 与 independent review 已完成；ii-b1 first-frame origin
audit 已前插 ii-b0c bootstrap，ii-b0c 是当前 frontier、ii-b1 next。
...
ii-b0a/ii-b0b 已完成，ii-b0c 是当前 frontier、ii-b1 next。
...
与 [ii-b0b claim/release review](../reports/phase-d-task-39b2c-l3c3c-ii-b0b-review.md)。
...
- Phase C deterministic Epic 8 safe-execution 详尽 plan 已于 2026-08-11
  ...
  superseded。signed App/helper machine gate 已得出 `signedRuntimeReady`，
	  ...
	  Proposed；L3c3c-ii-a 与 ii-b0a/ii-b0b 已完成，ii-b0c 是当前 frontier、
	  ii-b1 next。
	  L3c4 才拥有
