...
> 状态：用户已批准  
> 目的：记录产品头脑风暴中确认的设计基线；详细需求见 [PRD](../../PRD.md)，实现边界见 [技术架构](../../architecture.md)，完整界面规范见 [UI/UX 设计规格](2026-08-07-stornaut-ui-ux-design.md)。
...
完整、规范化的批准决策以 [PRD 第 15 节](../../PRD.md#15-已批准决策) 为唯一登记表。本节仅保留讨论过程中的里程碑，不作为第二份独立规范。
