...
>
> Authorized source tree: `a25134f6bcd37852b8ce38502301f95cc7b55d34`

## Authorization

The user explicitly authorized one fresh privileged Task 39 ii-c replacement
machine campaign based on the pushed exact-v13 preservation prerequisite above.
This one-shot authorization is named v15 to distinguish it from consumed
campaigns v8 through v13 and superseded/unconsumed v14. It permits the sealed
zero-argument campaign executable to generate one fresh nonzero campaign UUID,
one fresh nonzero attempt UUID and one fresh owner-private evidence root at the
unique launch.
...
- Once v15 durably records `armedConsumed`, the attempt is consumed. Any failure,
  uncertainty, cancellation, timeout or verifier rejection stops and forbids
  automatic retry or another campaign.
- No v8-v14 artifact, receipt, evidence root or historical Gate state may be
...
- A green independently verified v15 cohort may unblock L3c3d. It does not by
...
and pushed; historical v8-v14 evidence stays read-only; the fixed runtime is
