...
- [Phase D Task 39B2c-L3c3c-ii-b0 Wire Contract Clarification Preflight — 2026-08-19](phase-d-task-39b2c-l3c3c-ii-b0-wire-contract-preflight.md)：关闭 digest/config nonce/payload/transcript join 歧义，冻结 b0a frame/capsule 与 b0b claim/release bytes、预算及验证归属；both complete；ii-b1 current。
