...
- [Phase D Task 39B2c-L3c3c-ii-b0 Wire Contract Clarification Preflight — 2026-08-19](phase-d-task-39b2c-l3c3c-ii-b0-wire-contract-preflight.md)：关闭 digest/config nonce/payload/transcript join 歧义，冻结 b0a frame/capsule 与 b0b claim/release bytes、预算及验证归属；b0a/b0b/b0c/ii-b1 complete；ii-b2 current。
...
- [Phase D Task 39B2c-L3c3c-ii-b1 Authority-Free App Leaf Review — 2026-08-19](phase-d-task-39b2c-l3c3c-ii-b1-review.md)：package-scoped handoff state machine、fixed-FD App shell、Debug-only diagnostic/dependency-free Release-shell topology、9 focused、13 App、1,138-test staged-only serial 与 post-fix review；complete/non-admitting，ii-b2 current。
