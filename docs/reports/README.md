...
- [Phase D Task 39B2c-L3c3c-i Handoff/Launcher Spike Conditional Review — 2026-08-19](phase-d-task-39b2c-l3c3c-i-handoff-launcher-spike-review.md)：B3-v8 transport/lifecycle、B4 root-to-UID implementation/static evidence 与 i-b2a reproducibility 已完成；privileged i-b2b 未执行、ADR 0018 仍 Proposed、L3c3c-ii blocked。
- [Phase D Task 39B2c-L3c3c-i-b2a Reproducibility Contract Review — 2026-08-19](phase-d-task-39b2c-l3c3c-i-b2a-reproducibility-contract-review.md)：冻结 exact execution full SHA + normalized unsigned projection + signed semantic projection 三层 gate；i-b2a complete，i-b2b 未执行。
