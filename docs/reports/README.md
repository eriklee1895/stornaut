...
- [Phase D Task 39B2c-L3c3c-ii-b Handoff Composition Split Preflight — 2026-08-19](phase-d-task-39b2c-l3c3c-ii-b-split-preflight.md)：冻结 ii-b0–ii-b5 与 ii-c0 边界、canonical protocol/capsule、handle-free claim/release、per-epoch retirement 和 gate-side TTY/FD evidence；三轮 review 无 unresolved P0–P2；ii-b0 current；non-admitting。
