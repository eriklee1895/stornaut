...
- [Phase D Task 39B2c-L3c3c-ii Installed-Driver Path/Cost Preflight — 2026-08-19](phase-d-task-39b2c-l3c3c-ii-installed-driver-path-cost-preflight.md)：冻结 ii-a authority-closed runtime、ii-b fixed handoff、ii-c one no-model outer installed-driver gate。
