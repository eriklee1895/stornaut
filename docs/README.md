...
| 当前计划状态 | [Active Plans](plans/active/README.md) — Phase D approved；v8/v9 consumed failure 均只读固化且不可重试；v9 AMFI root-cause 修复已通过非提权 gates，新 campaign 未授权；Task 39 incomplete，L3c3d/L3c4 未证明；Task 40 仍阻塞 |
...
| Phase D Task 39 | [Implementation Brief](plans/active/task-39-implementation-brief.md) — v8/v9 consumed failure；v9 AMFI `-423` root-cause 修复已通过非提权 gates；新 campaign 未授权；L3c3d/L3c4 未证明，final full 未运行 |
...
| Phase D Task 39B2c ii-c Machine Campaign Preflight | [Frozen Campaign Split](reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) — ii-c-b complete/non-admitting；v8/v9 consumed/no-go；root-cause repair green；new campaign not authorized |
