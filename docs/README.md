...
| 当前计划状态 | [Active Plans](plans/active/README.md) — Phase D approved；Tasks 36–37 complete，Task 38 next |
...
| Phase D Task 38 | [Implementation Brief](plans/active/task-38-implementation-brief.md) — next |
