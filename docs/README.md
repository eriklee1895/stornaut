...
| 当前计划状态 | [Active Plans](plans/active/README.md) — Phase D approved；Task 39 in progress；ii-b5b-i-a/i-b1/i-b2a complete/non-admitting；i-b2b split，i-b2b-a current；ADR 0018 Proposed |
...
| Phase D Task 39B2c L3c3c-ii Installed-Driver Preflight | [Path and Cost Preflight](reports/phase-d-task-39b2c-l3c3c-ii-installed-driver-path-cost-preflight.md) — historical split；i-b2b-a current |
...
| Phase D Task 39B2c L3c3c-ii-b0 Wire Contract Preflight | [Exact Wire Split](reports/phase-d-task-39b2c-l3c3c-ii-b0-wire-contract-preflight.md) — historical split；i-b2b-a current |
...
| Phase D Task 39B2c L3c3c-ii-b3 Preflight | [App Adapter Split](reports/phase-d-task-39b2c-l3c3c-ii-b3-split-preflight.md) — historical split；i-b2b-a current；non-admitting |
...
| Phase D Task 39B2c L3c3c-ii-b4 Review | [Fixed Helper-Claim Client Completion Audit](reports/phase-d-task-39b2c-l3c3c-ii-b4-review.md) — complete；i-b2b-a current |
| Phase D Task 39B2c L3c3c-ii-b5 Preflight | [Single-Epoch Composition Split](reports/phase-d-task-39b2c-l3c3c-ii-b5-split-preflight.md) — i-b2b-a current；non-admitting |
...
| Phase D Task 39B2c L3c3c-ii-b5b-i-b2a Review | [Artifact/Static Readers Completion Audit](reports/phase-d-task-39b2c-l3c3c-ii-b5b-i-b2a-review.md) — 6 paths / 2,061 lines、1,328-test clean serial；complete/non-admitting；i-b2b-a current |
