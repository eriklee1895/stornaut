...
| 当前计划状态 | [Active Plans](plans/active/README.md) — Phase D approved；v8/v9 consumed failure 均只读固化且不可重试；v10 authorized/unconsumed and in preflight；Task 39 incomplete，L3c3d/L3c4 未证明；Task 40 仍阻塞 |
...
| Phase D Task 39 | [Implementation Brief](plans/active/task-39-implementation-brief.md) — v8/v9 consumed failure；v10 authorized/unconsumed and in preflight；L3c3d/L3c4 未证明，final full 未运行 |
| Phase D Task 39B2c v9 Failure Disposition | [Read-only Failure Audit](reports/phase-d-task-39b2c-iic-v9-failure-disposition.md) — consumed / non-admitting / non-retryable；AMFI `-423`；原 Gate residue v2 receipt 与后续 test-mutation v3 disposition |
...
| Phase D Task 39B2c v10 Authorization | [Replacement Campaign Amendment](reports/phase-d-task-39b2c-iic-v10-replacement-campaign-authorization.md) — fresh v10；bound to `05fd0cd`；authorized/unconsumed；operator-only credential entry |
...
| Phase D Task 39B2c ii-c Machine Campaign Preflight | [Frozen Campaign Split](reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) — ii-c-b complete/non-admitting；v8/v9 consumed/no-go；v10 authorized/unconsumed and in preflight |
