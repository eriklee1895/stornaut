...
| 当前计划状态 | [Active Plans](plans/active/README.md) — Phase D approved；v8/v9/v10/v11 consumed failure 均只读固化且不可重试；v12 authorized/pending/unconsumed at `0a17726`；Task 39 incomplete，Task 40 仍阻塞 |
...
| Phase D Task 39 | [Implementation Brief](plans/active/task-39-implementation-brief.md) — v8/v9/v10/v11 consumed failure；v12 authorized/pending/unconsumed at `0a17726`；L3c3d/L3c4 未证明 |
...
| Phase D Task 39B2c v12 Authorization | [Replacement Campaign Amendment](reports/phase-d-task-39b2c-iic-v12-replacement-campaign-authorization.md) — rebound to `0a17726`；authorized/pending/unconsumed |
...
| Phase D Task 39B2c ii-c Machine Campaign Preflight | [Frozen Campaign Split](reports/phase-d-task-39b2c-iic-machine-campaign-preflight.md) — ii-c-b complete/non-admitting；v8/v9/v10/v11 consumed/no-go；v12 authorized/pending/unconsumed at `0a17726` |
