...
18. [`0018-parent-owned-investigation-handoff.md`](0018-parent-owned-investigation-handoff.md) — Proposed for Task 39 L3c3c; i-b2a reproducibility complete, privileged i-b2b machine gate not executed
