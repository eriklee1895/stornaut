...
![A — Native Sidebar / Privacy & Data](settings-round1-a-sidebar-privacy-dark.webp)
...
![B — Toolbar Tabs / Permissions](settings-round1-b-toolbar-permissions-dark.webp)
...
![C — General + Setup Status](settings-round1-c-status-summary-general-dark.webp)
...
![D — Single Scroll](settings-round1-d-single-scroll-dark.webp)
...
![E — Local Knowledge](settings-round1-e-local-knowledge-dark.webp)
...
![Canonical General — Dark](settings-general-canonical-dark.webp)

![Canonical General — Light](settings-general-canonical-light.webp)

### Codex and Deep Dive

![Canonical Codex & Deep Dive — Dark](settings-codex-deep-dive-canonical-dark.webp)

![Canonical Codex & Deep Dive — Light](settings-codex-deep-dive-canonical-light.webp)

### Local Knowledge

![Canonical Local Knowledge — Dark](settings-local-knowledge-canonical-dark.webp)

![Canonical Local Knowledge — Light](settings-local-knowledge-canonical-light.webp)
