...
![A — Accounting Ledger](cleanup-result-round1-a-accounting-ledger-dark.webp)
...
![B — Reversible First](cleanup-result-round1-b-reversible-first-dark.webp)
...
![C — Plan versus Actual](cleanup-result-round1-c-plan-vs-actual-dark.webp)
...
![D — Manifest Timeline](cleanup-result-round1-d-manifest-timeline-dark.webp)
...
![E — Partial Outcome](cleanup-result-round1-e-partial-outcome-dark.webp)
...
![Canonical Cleanup Result — Dark](cleanup-result-canonical-dark.webp)

![Canonical Cleanup Result — Light](cleanup-result-canonical-light.webp)
