...
![A — Decision Table](review-round2-a-decision-table-dark.webp)
...
![B — Decision Cards](review-round2-b-decision-cards-dark.webp)
...
![C — Evidence Inspector](review-round2-c-evidence-inspector-dark.webp)
...
- `review-canonical-dark.webp` — canonical dark default Review reference.
- `review-canonical-light.webp` — canonical light counterpart with the same hierarchy and safety state.
- `review-round2-c-evidence-inspector-dark.webp` — canonical on-demand Inspector behavior reference until its theme pair is produced.
