...
![Canonical Overview — Dark](overview-canonical-dark.png)

### Canonical light reference

![Canonical Overview — Light](overview-canonical-light.png)
...
![Candidate A — Orbit Ledger](overview-round2-a-orbit-ledger-dark.png)
...
![Candidate B — Constellation](overview-round2-b-constellation-dark.png)
...
![Candidate C — Native Console](overview-round2-c-native-console-dark.png)
