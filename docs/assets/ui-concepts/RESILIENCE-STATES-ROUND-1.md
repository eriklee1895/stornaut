...
![Limited coverage dark](resilience-limited-coverage-canonical-dark.webp)

![Limited coverage light](resilience-limited-coverage-canonical-light.webp)
...
![Deep Dive safety blocked dark](resilience-deep-dive-safety-blocked-canonical-dark.webp)

![Deep Dive safety blocked light](resilience-deep-dive-safety-blocked-canonical-light.webp)
...
![Rejected safety-blocked draft](resilience-deep-dive-safety-blocked-draft-dark.webp)

## 3. Stale reclaim plan at execution preflight

![Stale plan dark](resilience-stale-plan-canonical-dark.webp)

![Stale plan light](resilience-stale-plan-canonical-light.webp)
...
![Partial investigation dark](resilience-partial-investigation-canonical-dark.webp)

![Partial investigation light](resilience-partial-investigation-canonical-light.webp)
...
![History expired evidence dark](resilience-history-expired-canonical-dark.webp)

![History expired evidence light](resilience-history-expired-canonical-light.webp)
