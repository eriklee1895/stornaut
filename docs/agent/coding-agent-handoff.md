...
> iii-b/ii-b2b 已关闭，ii-b3 是当前 frontier。之后为
...
block、iii-a、iii-b-i 与 iii-b-ii 均已完成，ii-b3 current，
...
ii-b3 concrete App drop/no-auth retirement adapter 是当前 frontier。
已完成部分均为
