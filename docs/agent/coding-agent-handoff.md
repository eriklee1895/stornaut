...
与 ii-c-b2a2、resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8/v9/v10/v11 均已消费失败且不可重试；post-arm diagnostic repair 已完成/non-admitting；fresh v12 在启动前因 preservation prerequisite suspended/unconsumed，修复后需 rebind；当前 frontier 为 preservation repair → v12 rebind/campaign → L3c3d → L3c4；这些 repairs 是 machine-campaign prerequisite
...
闭合；该修复 non-admitting。fresh v12 在启动前因 preservation prerequisite suspended/unconsumed，修复后需 rebind；当前 frontier 为 preservation repair → v12 rebind/campaign → L3c3d → L3c4。
ii-c-b2 的冻结拆分见
