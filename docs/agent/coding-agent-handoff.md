...
> 并保持 non-admitting，i-b2b 是当前 frontier；i-c 仍独占 DriverSupport
...
ii-b5 split；b5b-i-a/i-b1/i-b2a complete/non-admitting，i-b2b current，随后
...
i-a/i-b1/i-b2a complete/non-admitting；i-b2b current。i-b2a completion 见
...
i-b2b/i-b3，i-b2b 是当前 frontier；i-c 仍独占 DriverSupport join/legacy closure。
已完成部分均为
