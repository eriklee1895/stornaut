...
与 ii-c-b2a2、resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8/v9/v10/v11 均已消费失败且不可重试；preserved-capsule repair 已完成；fresh v12 已重新绑定至 `0a17726`，当前 authorized/pending/unconsumed；当前 frontier 为 authorization-only descendant → v12 campaign → L3c3d → L3c4；这些 repairs 是 machine-campaign prerequisite
...
ii-c-b2a2 与 resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8/v9/v10/v11 均已消费失败且不可重试；preserved-capsule repair 已完成；fresh v12 已重新绑定至 `0a17726`，当前 authorized/pending/unconsumed；当前 frontier 为 authorization-only descendant → v12 campaign → L3c3d → L3c4。
...
闭合；preserved-capsule repair 已完成；fresh v12 已重新绑定至 `0a17726`，当前 authorized/pending/unconsumed；当前 frontier 为 authorization-only descendant → v12 campaign → L3c3d → L3c4。
ii-c-b2 的冻结拆分见
