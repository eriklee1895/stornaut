...
one-shot receiver、private admission 与 same-owner containment proof；当前
frontier 为 iii-b2a-ii-a，剩余严格顺序为 iii-b2a-ii-a → iii-b2b →
...
complete/non-admitting，iii-b2a-ii-a current。i-b2a completion 见
...
non-admitting，iii-a/iii-b1/iii-b2a0/iii-b2a-i complete/non-admitting，
iii-b2a-ii-a current。
ii-a completion 见
...
保持 non-admitting，iii-b2a-ii-a 接续 Darwin physical session。
...
preflight 已冻结，iii-a/iii-b1/iii-b2a0/iii-b2a-i 已完成并保持
non-admitting，当前 frontier 为 iii-b2a-ii-a，之后为 iii-b2b、
ii-c0b、ii-c、L3c3d、L3c4。
已完成部分均为
