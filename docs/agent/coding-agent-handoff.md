...
replay `aa8a7f1` 均已完成并保持 non-admitting。ii-c-a 与 ii-c-b1 已完成；当前 frontier
为 ii-c-b2 → ii-c-c → L3c3d → L3c4；这些 repairs 是 machine-campaign prerequisite
...
identity binding `531f79f` / consumer seal `26e785a` 与 fixed-gate historical
replay `aa8a7f1` 均已完成/non-admitting。ii-c-a 与 ii-c-b1 已完成；current frontier 为
...
ii-c-a 与 ii-c-b1 已完成；当前 frontier 为 ii-c-b2，之后严格为 ii-c-c、L3c3d、L3c4。
这些 repairs 是
