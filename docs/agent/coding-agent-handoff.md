...
> 保持 non-admitting，b5b-ii fixed Darwin runtime 是当前 frontier。之后按序
> 为 b5b-iii
...
i-c1 与 aggregate i-c2 complete/non-admitting，ii-b5b-ii current，
...
i-a/i-b1/i-b2a/i-b2b-a/i-b2b-b/i-b3/i-c1 与 aggregate i-c2
complete/non-admitting；ii-b5b-ii current。i-b2a completion 见
...
PGID retirement 四个 bounded checkpoints；ii-a 当前。
...
ii-b5b-ii fixed Darwin runtime 是当前 frontier。
已完成部分均为
