...
与 ii-c-b2a2、resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8/v9 均已消费失败且不可重试；当前 frontier 为 v10 authorized/unconsumed preflight → one-shot campaign → L3c3d → L3c4；这些 repairs 是 machine-campaign prerequisite
...
ii-c-b2a2 与 resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8/v9 均已消费失败且不可重试；当前 frontier 为 v10 authorized/unconsumed preflight → one-shot campaign → L3c3d → L3c4。
...
已消费失败且不可重试；v9 也已消费失败且不可重试。当前 frontier 为
v10 authorized/unconsumed preflight → one-shot campaign → L3c3d → L3c4。
ii-c-b2 的冻结拆分见
