...
> process/service + narrow C identity 与 i-b3 observer composition，i-b2a 是当前
> frontier；i-c 仍独占 DriverSupport join/legacy-owner closure。之后按序
...
ii-b5 split；b5b-i-a/i-b1 complete/non-admitting，i-b2a current，随后
i-b2b/i-b3；i-c retains DriverSupport join/legacy closure，
...
i-a/i-b1 complete/non-admitting；i-b2a current。
...
b5a、b5b-i-a 与 i-b1 已完成并保持 non-admitting；b5b-i-b 余下 i-b2a/
i-b2b/i-b3，i-b2a 是当前 frontier；i-c 仍独占 DriverSupport join/legacy closure。
已完成部分均为
