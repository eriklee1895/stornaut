...
与 ii-c-b2a2、resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8–v12 均已消费失败且不可重试；credential repair 与 persistent Gate P1/P2 已完成/non-admitting；fresh v13 已授权，authorization-only descendant `c7c94eb` 已推送，pending/unconsumed；当前 frontier 为 v13 campaign → L3c3d → L3c4；这些 repairs 是 machine-campaign prerequisite
...
ii-c-b2a2 与 resolved-lineage L1/L2 已完成/non-admitting，L2 final review none；历史 pre-v8 顺序为 ii-c-c → L3c3d → L3c4；v8–v12 均已消费失败且不可重试；credential repair 与 persistent Gate P1/P2 已完成/non-admitting；fresh v13 已授权，`c7c94eb` 已推送，pending/unconsumed；当前 frontier 为 v13 campaign → L3c3d → L3c4。
...
闭合；v12 已从 `212320f` 唯一执行并 consumed/no-go；credential repair 与 persistent Gate P1/P2 已完成/non-admitting；fresh v13 已授权，`c7c94eb` 已推送，pending/unconsumed；当前 frontier 为 v13 campaign → L3c3d → L3c4。
ii-c-b2 的冻结拆分见
